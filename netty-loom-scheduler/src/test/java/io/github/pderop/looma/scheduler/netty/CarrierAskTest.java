...
import io.github.pderop.looma.AskTest;
import io.github.pderop.looma.ActorSystem;

/**
 * Runs the shared {@link AskTest} suite against the carrier-affine scheduler,
 * using the JVM-wide carrier pool installed by
 ...
 */
class CarrierAskTest extends AskTest {
