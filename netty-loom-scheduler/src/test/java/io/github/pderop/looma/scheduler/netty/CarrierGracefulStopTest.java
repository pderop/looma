...
import io.github.pderop.looma.GracefulStopTest;
import io.github.pderop.looma.ActorSystem;

/**
 * Runs the shared {@link GracefulStopTest} suite against the carrier-affine
 ...
 */
class CarrierGracefulStopTest extends GracefulStopTest {
